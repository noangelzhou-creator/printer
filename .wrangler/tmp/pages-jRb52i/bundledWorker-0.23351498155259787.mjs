...
var f = /* @__PURE__ */ __name((e, t, r) => xt(e, typeof t != "symbol" ? t + "" : t, r), "f");
...
var p = /* @__PURE__ */ __name((e, t, r, s) => (Ce(e, t, "write to private field"), s ? s.call(e, r) : t.set(e, r), r), "p");
...
var dt = (Ve = class {
  ...
  route(t, r) {
    ...
    return r.routes.map((n) => {
      var a;
      let i;
      r.errorHandler === Be ? i = n.handler : (i = /* @__PURE__ */ __name(async (l, o) => (await Fe([], r.errorHandler)(l, () => n.handler(l, o))).res, "i"), i[Bt] = n.handler), E(a = s, R, K).call(a, n.method, n.path, i);
    }), this;
  }
  basePath(t) {
...
}, C = /* @__PURE__ */ new WeakMap(), R = /* @__PURE__ */ new WeakSet(), ht = /* @__PURE__ */ __name(function() {
...
}, "K"), be = /* @__PURE__ */ __name(function(t, r) {
  if (t instanceof Error) return this.errorHandler(t, r);
  throw t;
}, "be"), Re = /* @__PURE__ */ __name(function(t, r, s, n) {
...
}, W = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), Te = /* @__PURE__ */ new WeakSet(), ft = /* @__PURE__ */ __name(function(e) {
  const t = [];
  let r = e === b;
...
// ../.wrangler/tmp/bundle-jxc6hj/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-jxc6hj/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.23351498155259787.mjs.map
